...
/**
 * Classe que representa a camada de negócios de Item
 * @generated
 **/
public class ItemBusiness {

  /**
   * Instância da classe ItemDAO que faz o acesso ao banco de dados
   * @generated
   */
  private ItemDAO dao;
   ...
   */
  public ItemBusiness(final SessionManager sessionmanager) {
    // begin-user-code
    // end-user-code
    this.sessionManager = sessionmanager;
    this.dao = new ItemDAO(sessionmanager.getEntityManager());
    // begin-user-code
    // end-user-code
  }
   ...
   * @generated modifiable
   */
  public void refresh(final Item entity) {
    // begin-user-code
    // end-user-code  
    dao.refresh(entity);
    // begin-user-code
  ...
  public Item update(final Item entity) {
    // begin-user-code
    // end-user-code  
	Item updatedEntity = dao.update(entity);
    // begin-user-code
    // end-user-code	
  ...
  public List<Item> list(int limit, int offset){
      // begin-user-code
      // end-user-code  
      List<Item> result = dao.list(limit, offset);
      // begin-user-code
      // end-user-code        
      return result;	
  }  
